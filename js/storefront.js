...
var filterResult1 = data.products.filter(function(d) { return (d.product_type == "Computers"); });
var filterResult2 = data.products.filter(function(d) { return (d.product_type == "Toys"); });
